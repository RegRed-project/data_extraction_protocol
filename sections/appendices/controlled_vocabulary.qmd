...
df <- read_xlsx(tmp, sheet = 'sourceLanguage') %>% 
...
df <- read_xlsx(tmp, sheet = 'sourceLicense') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'sourceType') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'sourceFormat') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
#| echo: false
#| eval: false
df <- read_xlsx(tmp, sheet = 'extractionType') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'sourceCategory') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'sourcePublisherType') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'geospatialScope') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'taxonomicScope') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'statusAssessmentType') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
...
df <- read_xlsx(tmp, sheet = 'continent') %>% 
  janitor::clean_names('lower_camel', abbreviations = 'ID') %>% 
  mutate(across(everything(), ~str_squish(str_trim(.)))) 
