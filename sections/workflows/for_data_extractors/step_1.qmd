...
[**RegRed**]{colour="#ff1428" bg-colour="#fff"} uses **EcoParse**, a tool that streamlines the AI automated method, but not all sources yield reliable results through automation. Before beginning to extract any data, Data Extractors will have to assess whether the source is appropriate for manual or automated extraction. 
...
## What is a red list for [**RegRed**]{colour="#ff1428" bg-colour="#fff"}?
