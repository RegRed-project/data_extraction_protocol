...
If it needs to be added, fill in the details about the new source in the [[new_sources](https://czuvpraze.sharepoint.com/:x:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/data/new_sources/new_sources.xlsx?d=wf01d3d61592a473488abcdc1e4d7b91d&csf=1&web=1&e=VJDcqK)]{colour="#fff" bg-colour="#31b0e0"} file and store any associated files in the  [[new_sources](https://czuvpraze.sharepoint.com/:f:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/data/new_sources?csf=1&web=1&e=gecFt8)]{colour="#fff" bg-colour="#3169e0"} folder.  
Then, you will go to the last row in the file, and create a new one using the consecutive number for the `sourceID` value.   

If you decide to extract the source, you must include it in the [[tetrapods_sources_to_extract](https://czuvpraze.sharepoint.com/:x:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/data/regred_tetrapods_sources_to_extract.xlsx?d=wf0ea428dc8d944aa8129214a38f69238&csf=1&web=1&e=UXEtEO)]{colour="#fff" bg-colour="#31b0e0"} file. You will add it will by creating a new line at the end of the document using the `sourceID` value created in the [[new_sources](https://czuvpraze.sharepoint.com/:x:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/data/new_sources/new_sources.xlsx?d=wf01d3d61592a473488abcdc1e4d7b91d&csf=1&web=1&e=VJDcqK)]{colour="#fff" bg-colour="#31b0e0"} file.
...
We keep a record of the weekly number of redlists done by each data extractor in our [[weekly_tracker](https://czuvpraze.sharepoint.com/:x:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/docs/weekly_targets/regred_weekly_tracker.xlsx?d=wdf640ca9627745c2ba2140ace94e186f&csf=1&web=1&e=qpMw0c)]{colour="#fff" bg-colour="#31b0e0"}.  
...
## How to know if the source has been extracted by the NRL?  
  ...
  -   Check the field `inNRL` in the [[tetrapods_sources_to_extract](https://czuvpraze.sharepoint.com/:x:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/data/regred_tetrapods_sources_to_extract.xlsx?d=wf0ea428dc8d944aa8129214a38f69238&csf=1&web=1&e=UXEtEO)]{colour="#fff" bg-colour="#31b0e0"}. 
  ...
  -   Find out which species were extracted by NRL, by using the [[NRL_match](https://czuvpraze.sharepoint.com/:f:/r/teams/czu-in19b7pkjs2ctzgp-Gainsandlosses/Sdilene%20dokumenty/RegRed/code/MatchNRL?csf=1&web=1&e=egwOdU)]{colour="#fff" bg-colour="#31b0e0"} script (copy the folder to your machine, fill in year and country and run it).  
...
If the source has already been fully extracted by NRL:   
  ...
  -   Continue with step [1.5 Create a folder and name it using the `sourceID`](step_1.html#create-a-folder-and-name-it-using-the-sourceid).   
