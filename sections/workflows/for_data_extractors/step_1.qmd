...
If you find a more complete file for the source (PDF or any digital format) you are extracting, you should replace it in the [all_sources_to_extract]{colour="#fffff" bg-colour="#3169e0"} folder.
...
If the source is easy to extract as a whole but difficult to split by class, you can use our [split_script]{colour="#fff" bg-colour="#31b0e0"} to automatically divide the Excel file into multiple class-specific files. 

**However**, to be able to do this, you must have extracted all the information in the red list first. Once you have done it, see the instruction in the [Filling the `taxon_assessment`](step_2.html#filling-the-taxon_asseessment-table) table section to use the script to divide the file into classes.
...
2. **File Location**   
Once you have finished extracting the source, you will save all files in the folder named after the `sourceID.`
