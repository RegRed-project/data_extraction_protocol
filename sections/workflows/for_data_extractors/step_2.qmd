...
All `verbatimStatusCode`s are mapped, by default, to the IUCN regional framework, and this mapping has `statusMappingSourceID = 1`:
...
```{mermaid}
flowchart TD
  Start(["source"]) --> IUCN{"Does it use IUCN v4.0 (2012)?"}
