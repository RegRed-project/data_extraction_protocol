...
If the source has already been fully extracted by NRL:   
  ...
  -   The NRL Data Harmoniser will have to adapt the source to [**RegRed**]{colour="#ff1428" bg-colour="#fff"}'s structure. You will be done with the source, and you will start over from step [1.2. Pick a source and report progress]().    
